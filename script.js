document.addEventListener("DOMContentLoaded", function() {
    const blackList = [
        ...
        { nome: "john Moura", rg: "1602", dataInclusao: "04/07/2024", motivo: "Falta de compromisso e calote no pagamento da multa por sair antes do prazo de contratação do HP/SAMU.", responsavel: "Melaniie india [4055]
", servicosNegados: "Compras de Bandagens, Compras de Bloody Mary, Tratamentos, Emissão do Laudo AP para o porte de arma, Fazer parte da equipe HP/SAMU", servicosLiberados: "Ser reanimado" }
    ];
